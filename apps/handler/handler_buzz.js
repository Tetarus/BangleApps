...
if (process.env.BOARD == "MAGIC3" || process.env.BOARD == "Magic3" || process.env.BOARD == "ROCK") buzzer.buzz = { na: [15, 15, 15], ok: 15, ln: 80, on: 40, off: [20, 25, 20] };
else buzzer.buzz = { ok: [20, 40, 20], na: 25, ln: 80, on: 40, off: [20, 25, 20] };
