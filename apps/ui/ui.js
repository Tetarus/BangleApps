UI = {
  ...
  pos: {
    _fold: [20, [79, 161], [65], [158, 158], [74]],
    _2x1: [28, [120], [80, 200], [240], [120, 120]],
    _2x2: [27, [60, 180], [80, 200], [120, 120], [120, 120]],
    _2x3: process.env.BOARD == "ROCK1" ? [30, [40, 118, 196], [62, 144], [78, 78, 78], [84, 84]] : [30, [38, 120, 202], [65, 144], [77, 77, 77], [74, 74]],
    _3x1: [25, [120], [60, 140, 220], [240], [80, 80, 80]],
    _4x1: [27, [120], [50, 110, 170, 230], [240], [60, 60, 60, 60]],
    _ind: [27, [120], [260], [240], [40]],
    ...
    _main: [25, [60, 180, 120], [45, 135, 110, 140, 140], [120, 120, 240], [50, 130, 180, 240, 280]],
  ...
  btn: {
    ...
    c3l: function (loc, no, po, txt1, txt2, fclr, bclr) {
      ...
      if (UIc.get[loc]) UIc.raw[loc] = UIc.raw[loc] + `${UIc.raw[loc] == " " ? "" : "else "}if (${x}-${szX}<x&&x<${x}+${szX}&&${y}-${szY}<y&&y<${y}+${szY}) UIc.${loc}.${no}(${po},l);`;
      else w.gfx.flip();
    },
    c1l: function (loc, no, po, txt1, txt2, fclr, bclr) {
      let p = UI.pos[no];
      let len = p[1].length;
      let x = p[1][(po - 1) % len];
    ...
    c2l: function (loc, no, po, txt1, txt2, fclr, bclr, size) {
      let p = UI.pos[no];
      let len = p[1].length;
      let x = p[1][(po - 1) % len];
      let y = p[2][((po - 1) / len) | 0];
      ...
      if (txt2 && txt2 != "") {
        ...
        w.gfx.drawString(txt2, x - w.gfx.stringWidth(txt2) / 2, y + (2.0 - UI.size.txt));
      } else {
  ...
  txt: {
    ...
    block: function (no, po, txt, len, fclr, bclr, tran) {
      ...
      else w.gfx.setFont("Teletext10x18Ascii", 1);
...
if (process.env.BOARD == "BANGLEJS2") {
  ...
  UI.pos = {
    _fold: [12, [58, 120], [30], [120, 120], [58]],
    _2x1: [25, [89], [40, 122], [176], [78, 78]],
    _2x2: [22, [45, 135], [40, 120], [88, 88], [78, 78]],
    _2x3: [24, [28, 87, 146], [30, 90], [56, 56, 56], [57, 57]],
    _3x1: [25, [90], [40, 120, 200]],
    _ind: [24, [89], [158], [176], [30]],
    _4x1: [22, [89], [25, 65, 105, 145], [176], [40, 40, 40, 40]],
    _kp4x3: [25, [30, 89, 145], [20, 58, 100, 140], [58, 58, 58], [40, 40, 40, 40]],
    _ele: { 0: 25, title: [0, 160, 176, 176, 16], titleTop: [0, 0, 176, 5, 14], ind: [60, 121, 120, 124], indF: [0, 120, 176, 125] },
    _bar: [20, [30, 87, 145, 45, 133, 87], [150], [58, 58, 58, 88, 88, 176], [55]],
    _1x2: [25, [90], [78, 135], [176], [78, 78]],
    _main: [23, [45, 133, 87], [20, 45, 55, 65, 87], [88, 88, 176], [40, 88, 110, 130, 176]],
