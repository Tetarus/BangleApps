...
exports.create = function (cb, conf) {
  ...
  if (o.c.dragableSlider) {
    ...
    o.f.dragSlider = (e) => {
      ...
      if (o.f.wasOnDragRect(o.v.exFirst, o.v.eyFirst)) {
        ...
        let cbObj;
        if (useMap && o.f.wasOnIndicator(o.v.exFirst)) {
          // If draging starts on the indicator, adjust one-to-one.

          let input = !o.c.horizontal ? Math.min(Y_MAX - e.y - o.c.yStart - (3 * o.c.rounded) / 4, o.c.height) : Math.min(e.x - o.c.xStart - (3 * o.c.rounded) / 4, o.c.width);
          ...
          // Heavily inspired by "updown" mode of setUI.
  ...
  if (o.c.drawableSlider) {
    ...
    o.f.draw = (level) => {
      ...
      g.setColor(o.c.colorFG)
        .fillRect(o.c.borderRect) // To get outer border...
        .setColor(o.c.colorBG)
        .fillRect(o.c.hollowRect) // ... and here it's made hollow.
        .setColor(0 == level ? o.c.colorBG : o.c.colorFG)
        .fillRect(o.f.updateBar((!o.c.rounded ? 0 : 2 * o.c._rounded) + level * o.c.STEP_SIZE)); // Here the bar is drawn.
      if (o.c.rounded && level === 0) {
        // Hollow circle indicates level zero when slider is rounded.
        g.setColor(o.c.colorFG)
          .fillCircle(o.c._xStart + o.c._rounded, o.c._yStart + o.c._height - o.c._rounded, o.c._rounded)
          .setColor(o.c.colorBG)
          .fillCircle(o.c._xStart + o.c._rounded, o.c._yStart + o.c._height - o.c._rounded, o.c._rounded - o.c.outerBorderSize);
      }
    };
  }
